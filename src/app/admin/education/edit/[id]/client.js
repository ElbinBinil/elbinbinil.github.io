...
import { updateEducation } from "../../../../../lib/adminOperations";
import { doc, getDoc } from "firebase/firestore";
import { db } from "../../../../../lib/firebase";
import { LoadingSpinner } from "../../../../components/Loading";

export default function EditEducationClient() {
  ...
  useEffect(() => {
    ...
    if (user && isAdmin && educationId) {
      fetchEducation();
    }
  }, [user, isAdmin, authLoading, educationId, router]);
        ...
        setFormData({
          ...
          achievements:
            data.achievements && data.achievements.length > 0
              ...
              : [""],
          courses:
            data.courses && data.courses.length > 0 ? data.courses : [""],
          order: data.order || 0,
        });
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateEducation(educationId, cleanedData);
