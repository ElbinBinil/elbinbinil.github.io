        ...
        >
          ...
          <div className="relative p-6 border-b border-gray-700">
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-emerald-500 to-teal-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                <svg
          ...
          <div className="p-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Stay tuned for quality content that will help you grow as a
                developer!
              </p>
            ...
            <div className="mt-4 p-3 bg-gray-700/50 rounded-lg border border-gray-600">
              <p className="text-xs text-gray-400 text-center">
                💌 Follow me on social media for updates when the blog launches!
              </p>
            </div>
          </div>
        </animated.div>
...
export default function Blog() {
  ...
  return (
    <>
      <div
        className="flex flex-col-reverse items-center justify-center lg:block w-full h-full cursor-pointer hover:scale-105 transition-all overflow-hidden"
