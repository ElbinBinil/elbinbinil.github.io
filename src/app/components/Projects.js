...
export default function Projects() {
  ...
  return (
    <div className="relative flex flex-col-reverse items-center justify-center lg:block">
      <svg
        id="ewEtQUf14pr1"
        className="w-full lg:absolute bottom-0 opacity-30"
        viewBox="0 0 455 256"
        cached="false"
      >
        <g transform="translate(57.250088 32.050721)">
          ...
          />
          <g id="ewEtQUf14pr30_to" transform="translate(-85.659565,-89.6748)">
            <path
      ...
      <div className="relative z-10 p-4 h-full flex flex-col">
        {/* Title */}
        <div className="text-center mb-4 lg:absolute lg:bottom-3 lg:left-3">
          <div className="bg-[#264653] border border-black font-bold w-fit px-5 py-2 rounded-lg">
            <h2 className="text-3xl lg:text-4xl text-[#E9C46A] font-bold">
              Projects
            </h2>
          </div>
        </div>
        ...
        {/* Projects Content */}
        <div className="flex-1 overflow-y-auto lg:mb-20">
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-80 overflow-y-auto">
              {projects.slice(0, 4).map((project, index) => (
                <div
                  key={project.id}
                  className="bg-[#e9c46a]/20 backdrop-blur-sm border border-[#f4a261]/50 rounded-lg p-4 hover:bg-[#e9c46a]/30 transition-all duration-300 cursor-pointer"
                >
                  <h3 className="text-[#264653] font-bold text-lg mb-2">
                    {project.title}
                  </h3>
                  {project.description && (
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {project.technologies
                        ...
                        .map((tech, techIndex) => (
                          <span
                            key={techIndex}
                            className="text-xs bg-[#264653] text-[#E9C46A] px-2 py-1 rounded border border-[#E9C46A]/50"
                          >
                            {tech}
                          </span>
                        ))}
                      {project.technologies.length > 3 && (
                        <span className="text-xs text-[#264653] font-medium">
                  ...
                  <div className="flex gap-2 text-xs">
                    {project.githubUrl && (
                      <a
                        ...
                        className="text-[#264653] hover:text-[#E9C46A] font-medium"
                      >
                        GitHub →
                      </a>
                    )}
              ...
              {projects.length > 4 && (
                <div className="col-span-full text-center">
                  <button className="text-[#264653] text-sm hover:text-[#E9C46A] transition-colors font-medium">
