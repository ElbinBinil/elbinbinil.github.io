...
export default function Education() {
  ...
  return (
    <div
      className="flex flex-col-reverse items-center justify-center lg:block cursor-pointer transition-opacity duration-300 hover:opacity-90"
      onClick={handleClick}
      role="button"
      tabIndex={0}
      onKeyDown={(e) => {
    ...
    >
      ...
      <div className="cursor-pointer hover:opacity-90 transition-all bg-[#264653] w-fit px-5 py-2 m-3 border border-black lg:absolute">
